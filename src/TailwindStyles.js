...
// Header as Header
export const HEADER_STYLE = "justify-center min-w-full py-4 mb-8 bg-white shadow-md";

// Header as Mobile
export const HOME_MOBILE_STYLE = "flex flex-col justify-center h-screen mx-20";
